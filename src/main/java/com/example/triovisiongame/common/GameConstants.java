package com.example.triovisiongame.common;

public class GameConstants {
    public static final String GREEN = "#9ee049";
    public static final String YELLOW = "#fff51f";
    public static final String BLUE = "#1e90ff";
    public static final String RED = "#ff441f";
